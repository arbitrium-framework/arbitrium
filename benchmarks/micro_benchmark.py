...
async def run_single_model_with_cot(
    question: str, model_name: str, arbitrium: Arbitrium
) -> dict[str, Any]:
    """
...
async def run_arbitrium_tournament(
    question: str, arbitrium: Arbitrium
) -> dict[str, Any]:
    """
...
async def main(args: dict[str, Any] | None = None) -> None:
    ...
    if args is None:
        parser = argparse.ArgumentParser(
            description="Micro-Benchmark: Single Model vs Arbitrium Framework"
        )
        parser.add_argument(
            "--config",
            type=str,
    ...
    print()
    print(
        "This benchmark provides a first data point for Arbitrium Framework value."
    )
    ...
    if single_model_results:
        ...
        print(
            f"  Arbitrium Tournament: ${tournament_result['cost_actual']:.4f}"
        )
    ...
    with open(output_path, "w") as f:
        f.write(
            "# Micro-Benchmark Results: Single Model vs Arbitrium Framework\n\n"
        )
    ...
    print()
    print(
        "This provides your first empirical evidence for Arbitrium Framework value!"
    )
