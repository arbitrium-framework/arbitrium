...
from arbitrium_core.support.config.env import get_ollama_base_url
from arbitrium_core.support.constants import calculate_safe_max_tokens
from arbitrium_core.support.logging import get_contextual_logger
from arbitrium_core.support.text.json import to_dict
...
class LiteLLMModel(BaseModel):
    ...
    async def generate(self, prompt: str) -> ModelResponse:
        ...
        effective_max_tokens = int(params["max_tokens"])
