...
from arbitrium_core.support.constants import DEFAULT_LOG_CACHE_SIZE
...
class ColorFormatter(logging.Formatter):
    ...
    def __init__(
        ...
        from arbitrium_core.support.terminal import MODEL_COLORS
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        from arbitrium_core.support.logging.structured import (
            build_context_parts,
        )
        ...
        if should_colorize:
            ...
            from arbitrium_core.support.terminal import strip_ansi_codes
    ...
    def _should_use_color(self) -> bool:
        from arbitrium_core.support.terminal import should_use_color
...
def _create_file_handler(
    ...
    try:
        ...
        from arbitrium_core.support.logging.structured import JSONFormatter
...
def setup_logging(
    ...
    from arbitrium_core.support.logging.structured import ContextFilter
