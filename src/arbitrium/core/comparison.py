...
class ReportGenerator:
    ...
    async def save_report_to_file(
        ...
        try:
            await self.host.write_file(f"{filename}", file_content)
...
class ModelComparison:
    ...
    async def _save_champion_report(
        ...
        await self.report_generator.save_report_to_file(content_type=f"arbitrium_champion_solution_{timestamp}", content=report_content)
